...
import TestCaseList from "@/components/custom/TestCaseList";
            ...
            <AccordionTrigger>
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col items-start text-left">
                  <span className="font-semibold text-base">{repo.fullName}</span>
                  <span className="text-xs text-muted-foreground font-normal">
                    {repo.defaultBranch || "main"} &bull; {repo.language || "N/A"}
                  </span>
                </div>
              </div>
            </AccordionTrigger>
